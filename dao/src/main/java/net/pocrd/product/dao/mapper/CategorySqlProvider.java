...
import net.pocrd.product.dao.entity.CategoryExample.Criteria;
import net.pocrd.product.dao.entity.CategoryExample.Criterion;
...
public class CategorySqlProvider {
    ...
    public String countByExample(CategoryExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("mt_product_category");
    ...
    public String deleteByExample(CategoryExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("mt_product_category");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(Category record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("mt_product_category");
        
        if (record.getId() != null) {
            sql.VALUES("id", "#{id,jdbcType=INTEGER}");
        }
        
        if (record.getIdPath() != null) {
            sql.VALUES("id_path", "#{idPath,jdbcType=VARCHAR}");
        }
        ...
        if (record.getDefaultFrontCategory() != null) {
            sql.VALUES("default_front_category", "#{defaultFrontCategory,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExample(CategoryExample example) {
        ...
        sql.SELECT("name");
        sql.SELECT("rank");
        sql.SELECT("default_front_category");
        sql.SELECT("created_at");
        sql.SELECT("modified_at");
        sql.SELECT("is_deleted");
        sql.FROM("mt_product_category");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        SQL sql = new SQL();
        sql.UPDATE("mt_product_category");
        ...
        if (record.getIdPath() != null) {
            sql.SET("id_path = #{record.idPath,jdbcType=VARCHAR}");
        }
        ...
        if (record.getDefaultFrontCategory() != null) {
            sql.SET("default_front_category = #{record.defaultFrontCategory,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Category record) {
        ...
        if (record.getIdPath() != null) {
            sql.SET("id_path = #{idPath,jdbcType=VARCHAR}");
        }
        ...
        if (record.getDefaultFrontCategory() != null) {
            sql.SET("default_front_category = #{defaultFrontCategory,jdbcType=VARCHAR}");
        }
