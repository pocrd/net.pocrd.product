...
import net.pocrd.product.dao.entity.ItemExample.Criteria;
import net.pocrd.product.dao.entity.ItemExample.Criterion;
...
public class ItemSqlProvider {
    ...
    public String countByExample(ItemExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("mt_product_item");
    ...
    public String deleteByExample(ItemExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("mt_product_item");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(Item record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("mt_product_item");
        ...
        if (record.getIsMutiple() != null) {
            sql.VALUES("is_mutiple", "#{isMutiple,jdbcType=TINYINT}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getIsMutiple() != null) {
            sql.SET("is_mutiple = #{record.isMutiple,jdbcType=TINYINT}");
        }
    ...
    public String updateByPrimaryKeySelective(Item record) {
        ...
        if (record.getIsMutiple() != null) {
            sql.SET("is_mutiple = #{isMutiple,jdbcType=TINYINT}");
        }
