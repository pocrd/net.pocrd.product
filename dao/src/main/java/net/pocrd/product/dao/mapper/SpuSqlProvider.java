...
import net.pocrd.product.dao.entity.SpuExample.Criteria;
import net.pocrd.product.dao.entity.SpuExample.Criterion;
...
public class SpuSqlProvider {
    ...
    public String countByExample(SpuExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("mt_product_spu");
    ...
    public String deleteByExample(SpuExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("mt_product_spu");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(Spu record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("mt_product_spu");
